...
class UtilTests(TestCase):
    ...
    def test_get_provider_data(self):
        ...
        provider_data = get_provider_data(self.site, 'ASU')
    ...
    def test_get_provider_data_unavailable_request(self):
        ...
        """
        httpretty.register_uri(
            httpretty.GET, self.site.siteconfiguration.build_lms_url('api/credit/v1/providers/ABC'),
            status=400
        )
        provider_data = get_provider_data(self.site, 'ABC')
    ...
    def test_exceptions(self, exception):
        ...
        with mock.patch.object(requests, 'get', mock.Mock(side_effect=exception)):
            self.assertIsNone(get_provider_data(self.site, 'ABC'))
