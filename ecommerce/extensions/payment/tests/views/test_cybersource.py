...
from ecommerce.extensions.payment.tests.mixins import (
    PaymentEventsMixin, CybersourceMixin, CybersourceNotificationTestsMixin
)
...
@ddt.ddt
class CybersourceNotifyViewTests(CybersourceNotificationTestsMixin, PaymentEventsMixin, TestCase):
...
@ddt.ddt
class CybersourceInterstitialViewTests(CybersourceNotificationTestsMixin, PaymentEventsMixin, TestCase):
