...
class TestUrls(TestCase):
    def test_unauthorized_redirection(self):
        ...
        expected_url = self.site.siteconfiguration.student_dashboard_url
        # The test client can't fetch external URLs, so fetch_redirect_response is set to False to
        # avoid loading the final page.
